...
test.describe.serial('Reward Employee Tests', () => {
    ...
    test('Create reward with valid information', async ({ page }) => {
        ...
        await rewardEmployeePage.clickOnAddButton();
        await rewardEmployeePage.clickCancelButton();
        await rewardEmployeePage.clickOnAddButton();
        await rewardEmployeePage.fillRewardName('Reward Employee 1');
        ...
        await rewardEmployeePage.fillDescriptionInput('Description 1');
        await rewardEmployeePage.fillNoteInput('Note 1');
    ...
    test('Cancel reward', async ({ page }) => {
        ...
        await rewardEmployeePage.clickReasonCancelInput('Reason cancel');
    ...
    test('Search with reward name and employee name, reward type, date, status', async ({ page }) => {
        ...
        await rewardEmployeePage.clickRewardEmployee();
        await rewardEmployeePage.fillSearchByRewardName('Reward Employee 1');
